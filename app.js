...
},{"./tag/list.tag":7,"./tag/search.tag":8,"riot":2}],7:[function(require,module,exports){
var riot = require('riot');
module.exports = riot.tag('list', '<ul> <li each="{ opts.data }" class="listItem"> <span class="listItem__head">{id}</span> <span class="listItem__content"><a href="http://category.auctions.yahoo.co.jp/list/{id}/" class="link" target="_blank">{title}</a></span> </li> </ul>', 'list , [riot-tag="list"] { display: block; overflow: hidden; }', function(opts) {var _this = this;
...
var riot = require('riot');
module.exports = riot.tag('search', '<input class="input__text +luminous" type="text" name="keyword" placeholder="search keyword"> <div class="message">{this.message}</div>', function(opts) {var _this = this;
  ...
  request.get('' + opts.uri + '/search/keyword/' + keyword).end(function (err, res) {
    ...
    if (res.status === 200) {
      if (res.body.length > 0) {
        _this.message = '' + res.body.length + ' Hit!';
      } else {
